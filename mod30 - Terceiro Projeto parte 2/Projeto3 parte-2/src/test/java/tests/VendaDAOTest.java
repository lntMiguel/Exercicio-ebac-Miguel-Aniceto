...
public class VendaDAOTest {
	...
	public void salvarVendaMesmoCodigoExistente() throws TipoChaveNaoEncontradaException, DAOException, MaisDeUmRegistroException, TableException {
	...
	private Venda criarVenda(String codigo) throws MaisDeUmRegistroException, TableException, DAOException {
	...
	private void excluirVendas() throws DAOException {
		String sqlProd = "DELETE FROM TB_ITEM_VENDA";
