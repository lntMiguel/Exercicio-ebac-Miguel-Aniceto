...
public class ProdutoDAO extends GenericDAO<Produto, String> implements IProdutoDAO {
	...
	public void atualiarDados(Produto entity, Produto entityCadastrado) {
		...
		entityCadastrado.setFornecedor(entity.getFornecedor());
	...
	protected String getQueryInsercao() {
		...
		sb.append("(CODIGO, NOME, DESCRICAO, VALOR, FORNECEDOR, QUANTIDADE)");
		sb.append("VALUES (?,?,?,?,?,?)");
		return sb.toString();
	}
	...
	protected void setParametrosQueryInsercao(PreparedStatement stmInsert, Produto entity) throws SQLException {
		...
		stmInsert.setInt(6, entity.getQuantidade());
	}
	...
	protected void setParametrosQueryAtualizacao(PreparedStatement stmUpdate, Produto entity) throws SQLException {
		...
		stmUpdate.setString(5, entity.getFornecedor());
		stmUpdate.setInt(6, entity.getQuantidade());
